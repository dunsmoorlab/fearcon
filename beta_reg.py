...
for sub in all_sub_args:
	...
	for phase in fsl_betas:
		...
		os.system('flirt -in %s -ref /usr/local/fsl/data/standard/MNI152_T1_1mm_brain.nii.gz -out %s -init %s -applyxfm'%(os.path.join(subj.bold_dir,fsl_betas[phase]), new_img,omat))
